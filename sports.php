...
<body>
    ...
    <div class="car-info">
        ...
        <div class="benz-cars">
            <img src="images/sports1.jpg" alt="Car 1">
            <img src="images/sports2.jpg" alt="Car 2">
            <img src="images/sports3.jpg" alt="Car 3">
        </div>
    </div>
    <hr>
    ...
    <div class="overview">
        <h2>Overview</h2><br>
        <p>A sports car is a car designed with an emphasis on dynamic performance, such as handling, 
            acceleration, top speed, the thrill of driving, and racing capability. Sports cars originated in 
            Europe in early 1910s and are currently produced by many manufacturers around the world.
             </div>
    ...
    <div class="rentor">
        ...
        <div class="user">
            ...
            <span style="font-size: 30px;"><b>Joseph Lopez</b></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
