...
<body>
    ...
    <div class="car-info">
        ...
        <div class="benz-cars">
            <img src="images/mahindra1.jpg" alt="Car 1">
            <img src="images/mahindra2.jpg" alt="Car 2">
            <img src="images/mahindra3.jpg" alt="Car 3">
        </div>
    </div>
    <hr>
    ...
    <div class="overview">
        <h2>Overview</h2><br>
        <p> Mahindra is an automobile manufacturing company located in Mumbai, Maharashtra. It was established in
             1945 as Mahindra & Mohammed and later renamed Mahindra & Mahindra. 
            Part of the Mahindra Group, M&M is one of the largest vehicle manufacturers by production in India.
             </div>
    ...
    <div class="rentor">
        ...
        <div class="user">
            ...
            <span style="font-size: 30px;"><b>Daniel Anderson</b></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
