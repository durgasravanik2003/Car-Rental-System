...
<body>
    ...
    <div class="car-info">
        ...
        <div class="benz-cars">
            <img src="images/maruthi1.jpg" alt="Car 1">
            <img src="images/maruthi2.jpg" alt="Car 2">
            <img src="images/maruthi3.jpg" alt="Car 3">
        </div>
    </div>
    <hr>
    ...
    <div class="overview">
        <h2>Overview</h2><br>
        <p>Maruti Suzuki India Limited (MSIL), a subsidiary of Suzuki Motor Corporation, Japan, is India’s largest
    ...
    <div class="rentor">
        ...
        <div class="user">
            ...
            <span style="font-size: 30px;"><b>Richard Hernandez</b></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
