...
<body>
    ...
    <div class="car-info">
        ...
        <div class="benz-cars">
            <img src="images/audi1.jpg" alt="Car 1">
            <img src="images/audi2.jpg" alt="Car 2">
            <img src="images/audi3.jpg" alt="Car 3">
        </div>
    </div>
    <hr>
    ...
    <div class="overview">
        <h2>Overview</h2><br>
        <p>Audi brand automobiles have been around for more than 100 years, building upon a progressive line
             of innovative luxury vehicles. What makes Audi cars unique from other manufacturers is their 
             commitment to excellence, elegance, and winning features that you won't find anywhere else.
        </div>
    ...
    <div class="rentor">
        ...
        <div class="user">
            ...
            <span style="font-size: 30px;"><b>Michael Johnson</b></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
